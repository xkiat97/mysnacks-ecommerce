<%@ Page Title="" Language="C#" MasterPageFile="~/OnlyAdmin/Admin.Master" AutoEventWireup="true" CodeBehind="IngredientFoodAdd.aspx.cs" Inherits="HNEnterpreneur.OnlyAdmin.IngredientFoodAdd" %>
                                ...
                                <asp:DataList ID="dlFood" runat="server" RepeatLayout="Flow" DataKeyField="foodId" DataSourceID="dsFood" RepeatDirection="Horizontal">
                                    <ItemTemplate>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="IngredientFoodDel.aspx?Id=<%# Eval("ingID") %>&Id1=<%# Eval("foodID") %>" class="btn btn-sm btn-outline-danger btn-block">Remove</a>
                                            </td>
                                        </tr>
                                    </ItemTemplate>
                                </asp:DataList>
