<%@ Page Title="" Language="C#" MasterPageFile="~/OnlyStoreAdmin/Store.Master" AutoEventWireup="true" CodeBehind="BiddingDetail.aspx.cs" Inherits="HNEnterpreneur.OnlyStoreAdmin.BiddingDetail" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="body" runat="server">
    ...
    <div class="container">
        <form id="form1" runat="server" class="col-md-10">
                ...
                <div class="col-lg-7">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-3">
                                <button id="btnBidder" runat="server" type="button" class="btn btn-outline-info btn-block" data-toggle="modal" data-target="#bidder"></button>
                            </div>
                            <div class="col-md-3">
                                <asp:Button ID="btnBan" runat="server" Text="" CssClass="btn btn-outline-danger btn-block" OnClick="btnBan_Click" CausesValidation="False" ValidateRequestMode="Inherit" UseSubmitBehavior="False" />
                            </div>
                        </div>
                        <br />
            ...
            <!-- The Modal -->
            <asp:LinqDataSource ID="ldsBidder" runat="server" ContextTypeName="HNEnterpreneur.HNEnterpreneurDBDataContext" EntityTypeName="" OrderBy="price, date" TableName="Quotations" Where="bidID == @bidID && status != @status">
                <WhereParameters>
                    <asp:ControlParameter ControlID="lblBidId" PropertyName="Text" Name="bidID" Type="Int32"></asp:ControlParameter>
                    <asp:Parameter DefaultValue="F" Name="status" Type="Char"></asp:Parameter>
                </WhereParameters>
            </asp:LinqDataSource>
            <div class="modal fade" id="bidder">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">

                        <!-- Modal Header -->
                        <div class="modal-header">
                            <h4 class="modal-title">Bidder List</h4>
                            ...
                            <div class="card mb-3">
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table table-bordered" id="bidderTable" width="100%" cellspacing="0">
                                            <thead>
                                                <tr>
                                                    <th>Date</th>
                                                    <th>Company Name</th>
                                            ...
                                            <tbody>
                                                <asp:DataList ID="dlbidder" runat="server" RepeatLayout="Flow" RepeatDirection="Horizontal" DataSourceID="ldsBidder">
                                                    <ItemTemplate>
                                                        <tr>
                                                            <td><%# Eval("date") %></td>
                                                            <td><%# Eval("Bidder.name") %></td>
                                                            <td><%# Eval("quantity") %> <%# Eval("Bidding.Ingredient.balanceType") %></td>
                                                            <td><%# Eval("price") %></td>
                                                            <td><%# Eval("desc") %></td>
                                                            <td>
                                                                <a onclick="del(<%# Eval("quoID") %>)" href="" class="btn btn-sm btn-outline-danger btn-block bidRemove">Remove</a>
                                                            </td>
                                                        </tr>
                                                    </ItemTemplate>
                                                </asp:DataList>
