<%@ Page Title="" Language="C#" MasterPageFile="~/OnlySupplier/Supplier.Master" AutoEventWireup="true" CodeBehind="SupplierBiddingAdd.aspx.cs" Inherits="HNEnterpreneur.OnlySupplier.SupplierBiddingAdd" %>
                ...
                <div class="col-lg-7">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-3">
                                <asp:Button ID="btnBid" runat="server" Text="Confirm Bid" CssClass="btn btn-primary btn-block" OnClick="btnBid_Click"/>
                            </div>
                        </div>
                        <br />
                    </div>
